    ...
    public bool Execute()
    {
        ...
        Fc.Open(CPH, ExtensionInfo.Title, ExtensionInfo.Version, ui => ui
                ...
                .Section("General", "General", s => s
                    .Intro("Award the first chatters of each stream. " + "Use a **Twitch Chat Message** trigger for the main action and **Twitch Stream Online** for reset. " + "When all spots are claimed, main disables itself; reset re-enables it.")
