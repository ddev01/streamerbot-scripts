        ...
        Fc.Open(CPH, ExtensionInfo.Title, ExtensionInfo.Version, ui => ui
                ...
                .Section("General", "General", s => s
                    ...
                    .Dropdown("Default mode", "default_mode")
                        ...
                        .Options(new[] { ("discount", "Fixed multiplier"), ("random", "Random multiplier"), ("free", "Free (1 point)"), })
                        .DefaultByValue("discount")
                    .NumberInput("Price multiplier", "default_multiplier")
                        ...
                        .Default(0.5)
                        .Size("w-fit min-w-24")
                        .ShowWhen("default_mode", "discount")
                    ...
                    .Combobox("Auto-end timer", "timer_id")
                        .Hint("Paste the timer Id that runs the End action. Needed so timed sales can auto-end.")
                        .AllowCustom()
                        .Size("w-full")
                ...
                .Section("Rewards", "Rewards", r => r
                    .Intro("Leave include empty to affect every channel point reward. Exclude always wins. " + "Refresh loads groups from your Twitch rewards. You can also type a name that is not in the list.")
                    ...
                    .Dropdown("Exclude groups", "exclude_groups")
                        .Hint("Skipped even if listed under include.")
                        .Searchable()
                        .AllowCustom()
                        .Multiple()
                        .Refresh(() => Fc.TwitchRewardGroups(CPH))
